...
const Home =()=>{
     ...
     return(
        <div className='flex sm:flex-col h-fit md:h-screen font-dedact pb-20 justify-center flex-col font-reem font md:flex-row' >
               ...
               <img className='w-80 max-sm:pl-7 h-96 z-10  object-cover'  src={profile}/>
                ...
                <div className='flex gap-4 mt-4 font-kanit'>
                   ...
                   duration-200 p-2  w-32 rounded text-white hover:text-black'>Check Resume</button></a>
                    <a  className=' duration-200 border-gray-500 border rounded hover:bg-amber-300 hover:border-none'><button className='hover:text-black text-white duration-200 p-2  w-32 rounded '>Reach me here</button></a>
                </div>
            </div>
        </div>
     )
